...
class InfiniteViewPager_Horizon extends PagerAdapter {
    ...
    public InfiniteViewPager_Horizon(Context context, int[] mResources, String[] title) {
        mContext = context;
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        View itemView = mLayoutInflater.inflate(R.layout.horizon_custom_viewpager_item, container, false);
        Typeface normal_bold = Typeface.createFromAsset(mContext.getAssets(), "fonts/CenturySchoolbook-Bold.otf");

        final TextView textView = (TextView) itemView.findViewById(R.id.horizon_imageView);
        final Button btn_viewmore = (Button) itemView.findViewById(R.id.horizon_viewmore_button);
        textView.setBackgroundResource(mResources[position]);
        textView.setText(title[position]);
        textView.setTypeface(normal_bold);
        //textView.setTextColor(mContext.getResources().getColor(R.color.black));
        btn_viewmore.setTypeface(normal_bold);
