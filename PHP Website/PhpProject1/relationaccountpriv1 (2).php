...
$servername = "localhost";
  ...
  $query="SELECT Name FROM user where id_no in (select id_no from tables where tables_name in (select distinct table_name from accesses where role_name ='".$parent."'))";
